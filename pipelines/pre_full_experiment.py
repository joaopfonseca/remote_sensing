...
_X_tr, _X_te, _y_tr, _y_te = train_test_split(X, y, test_size=0.4, random_state=random_state)
...
gini_imp_feat_sel = SelectFromModel(clf, prefit=True, threshold='.9*mean')
