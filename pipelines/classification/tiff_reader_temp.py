...
## own libraries
from src.preprocess.readers import TIFFProductReader
...
################################################################################
## data path configs
DATA_PATH = PROJ_PATH+'/data/tiff_files/'
TIFF_PATH = DATA_PATH+'ascVV_VH.tif'
COS_PATH = DATA_PATH+'COS2015/COS2015_v2_08_02_2019_clip.shx'
...
if read_csv:
    ...
    print('Reading image...')
    img = TIFFProductReader(
        TIFF_path=DATA_PATH,
        labels_shapefile=COS_PATH,
        label_col='Legend'
    )
    #img.add_indices(['NDVI', 'NDBI', 'NDMI', 'NDWI'])
    img.get_X_array()
    img.get_y_array()
