...
window_size  = 33           # Size of the window to pass to the CNN
...
for epoch in range(1,n_epochs+1):
    ...
    for _, split_indices in skf.split(X_coords, y_labels):
        ...
        ResNet.fit(X_patches, y_split, batch_size=256, epochs=1)
...
df.to_csv(PROCESSED_PATH+'classification_results_resnet.csv')
